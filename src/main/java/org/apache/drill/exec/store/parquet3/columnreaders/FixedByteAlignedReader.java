...
class FixedByteAlignedReader<V extends ValueVector> extends ColumnReader<V> {
  ...
  public static class FixedBinaryReader extends
      org.apache.drill.exec.store.parquet3.columnreaders.FixedByteAlignedReader<VariableWidthVector> {
  ...
  public static abstract class ConvertedReader<V extends ValueVector> extends
      org.apache.drill.exec.store.parquet3.columnreaders.FixedByteAlignedReader<V> {
