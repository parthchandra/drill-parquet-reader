...
import org.apache.drill.exec.store.parquet3.ParquetGroupScan;
import org.apache.drill.exec.store.parquet3.ParquetRecordWriter;
...
public class ParquetFormatPlugin implements FormatPlugin{
  ...
  private final org.apache.drill.exec.store.parquet3.ParquetFormatConfig config;
  private final StoragePluginConfig storageConfig;
  private final String name;

  public ParquetFormatPlugin(String name, DrillbitContext context, Configuration fsConf,
      StoragePluginConfig storageConfig){
    this(name, context, fsConf, storageConfig, new org.apache.drill.exec.store.parquet3.ParquetFormatConfig());
  }

  public ParquetFormatPlugin(String name, DrillbitContext context, Configuration fsConf,
      StoragePluginConfig storageConfig, org.apache.drill.exec.store.parquet3.ParquetFormatConfig formatConfig){
  ...
  private static class ParquetFormatMatcher extends BasicFormatMatcher{
    ...
    public ParquetFormatMatcher(org.apache.drill.exec.store.parquet3.ParquetFormatPlugin plugin) {
